...
const resetErrorMessages = () => {
  let errorMessages = document.querySelectorAll(
    ".contacts-form__error-message_active",
  );
...
const displayErrorMessage = (input, message) => {
  ...
  parentDiv
    .querySelector(".contacts-form__label")
    .classList.add("contacts-form__label_error");

  parentDiv
    .querySelector(".contacts-form__input")
    .classList.add("contacts-form__input_error");

  parentDiv.querySelector(".contacts-form__error-message").textContent =
    message;

  parentDiv
    .querySelector(".contacts-form__error-message")
    .classList.add("contacts-form__error-message_active");
};
